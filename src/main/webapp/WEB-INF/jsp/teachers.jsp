              ...
              <c:forEach var="teacher" items="${requestScope.teachers}">
                <tr>
                  ...
                  <td class="p-3 text-center flex justify-center gap-3">
                    <a href="${pageContext.request.contextPath}/school-app/teachers/view/teacher?id=${teacher.id}" class="text-blue-500">
                      <i class="fa-solid fa-eye"></i>
                    </a>
                    <c:if test="${sessionScope.role == 'ADMIN'}">
                      <a href="${pageContext.request.contextPath}/school-app/teachers/update?id=${teacher.id}" class="text-green-500">
                        <i class="fa-regular fa-pen-to-square"></i>
                      </a>
                      <a href="${pageContext.request.contextPath}/school-app/teachers/delete?id=${teacher.id}" class="text-red-500">
