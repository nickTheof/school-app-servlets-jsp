  ...
  <body>
    ...
    <main class="w-full lg:w-4/5 bg-[#ECEBEC]">
        ...
        <form method="POST" action="${pageContext.request.contextPath}/school-app/teachers/insert">
          <div
            class="p-1 flex flex-wrap justify-center items-center gap-x-1 gap-y-3"
          >
            <div class="w-4/5 mx-auto lg:w-2/5 lg:mx-0 border h-16">
              <div
                class="flex flex-row items-center justify-center lg:justify-start gap-x-3"
              >
                <label for="firstname" class="font-bold text-sm w-[140px]"
                  >'Ονομα *</label
                >
                <input
                  id="firstname"
              ...
              <div
                class="text-red-600 text-sm mt-1 text-center lg:text-start"
              >
            ...
            <div class="w-4/5 mx-auto lg:w-2/5 lg:mx-0 border h-16">
              <div
                class="flex flex-row items-center justify-center lg:justify-start gap-x-3"
              >
                <label for="lastname" class="font-bold text-sm w-[140px]"
                  >Επώνυμο *</label
                >
                <input
                  id="lastname"
              ...
              <div
                class="text-red-600 text-sm mt-1 text-start md:text-center lg:text-start"
              >
            ...
            <div class="w-4/5 mx-auto lg:w-2/5 lg:mx-0 border h-16">
              <div
                class="flex flex-row items-center justify-center lg:justify-start gap-x-3"
              >
                <label for="vat" class="font-bold text-sm w-[140px]"
                  >ΑΦΜ *</label
                >
                <input
                  id="vat"
            ...
            <div class="w-4/5 mx-auto lg:w-2/5 lg:mx-0 border h-16">
              <div
                class="flex flex-row items-center justify-center lg:justify-start gap-x-3"
              >
                <label for="fatherName" class="font-bold text-sm w-[140px]"
                  >Πατρώνυμο *</label
                >
                <input
                  id="fatherName"
            ...
            <div class="w-4/5 mx-auto lg:w-2/5 lg:mx-0 border h-16">
              <div
                class="flex flex-row items-center justify-center lg:justify-start gap-x-3"
              >
                <label for="phoneNumber" class="font-bold text-sm w-[140px]"
                  >Τηλέφωνο *</label
                >
                <input
                  id="phoneNumber"
            ...
            <div class="w-4/5 mx-auto lg:w-2/5 lg:mx-0 border h-16">
              <div
                class="flex flex-row items-center justify-center lg:justify-start gap-x-3"
              >
                <label for="email" class="w-[140px] font-bold text-sm"
                  >Email *</label
                >
                <input
                  id="email"
            ...
            <div class="w-4/5 mx-auto lg:w-2/5 lg:mx-0 border h-16">
              <div
                class="flex flex-row items-center justify-center lg:justify-start gap-x-3"
              >
                <label for="address" class="w-[140px] font-bold text-sm"
                  >Διεύθυνση *</label
                >
                <input
                  id="street"
            ...
            <div class="w-4/5 mx-auto lg:w-2/5 lg:mx-0 border h-16">
              <div
                class="flex flex-row items-center justify-center lg:justify-start gap-x-3"
              >
                <label for="streetNum" class="w-[140px] font-bold text-sm"
                  >Αριθμός *</label
                >
                <input
                  id="streetNum"
            ...
            <div class="w-4/5 mx-auto lg:w-2/5 lg:mx-0 border h-16">
              <div
                class="flex flex-row items-center justify-center lg:justify-start gap-x-3"
              >
                <label for="city" class="w-[140px] font-bold text-sm"
                  >Πόλη *</label
                >
                ...
                <select
                  ...
                  required
                >
                  <option value="" disabled ${empty insertDTOInfo.cityId ? 'selected' : ''}>
                    Select City
                  </option>
                  <c:forEach var="city" items="${requestScope.cities}" >
                     <option value="${city.id}" ${city.id eq insertDTOInfo.cityId ? 'selected' : ''}>
                         ${city.name}
                     </option>
                  </c:forEach>
                </select>
            ...
            <div class="w-4/5 mx-auto lg:w-2/5 lg:mx-0 border h-16">
              <div
                class="flex flex-row items-center justify-center lg:justify-start gap-x-3"
              >
                <label for="zipcode" class="w-[140px] font-bold text-sm"
                  >ΤΚ *</label
                >
                <input
                  id="zipcode"
            ...
            <div
              class="lg:hidden text-center text-[#762124] hover:text-[#5c1a1a] mb-[10px]"
            >
              <a
