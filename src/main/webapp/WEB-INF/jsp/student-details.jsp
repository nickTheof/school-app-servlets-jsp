...
<html lang="el">
  <head>
    ...
    <title>Coding Factory - Αναλυτικά Στοιχεία Μαθητή</title>
  </head>
  <body>
      ...
      <aside class="hidden lg:block w-1/5 bg-[#762124]">
        <nav class="text-lg">
          <ul class="flex flex-col mt-[30px] ps-5 gap-y-2">
            <li>
              <a class="text-white text-lg hover:text-yellow-400 block" href="${pageContext.request.contextPath}/school-app/dashboard">Αρχική</a>
            </li>
            <li class="text-white">
              Μητρώο Εκπαιδευτών
              <ul class="ps-3 text-base">
                <li>
                  <a class="hover:text-yellow-400 block" href="${pageContext.request.contextPath}/school-app/teachers/view">Προβολή Εκπαιδευτών</a>
                </li>
                <c:if test="${sessionScope.role == 'ADMIN'}">
                  <li>
                    <a class="hover:text-yellow-400 block" href="${pageContext.request.contextPath}/school-app/teachers/insert">Εισαγωγή Εκπαιδευτή</a>
                  </li>
                </c:if>
              </ul>
            </li>
      ...
      <main class="w-full lg:w-4/5">
        <div class="w-full px-4 md:px-12 xl:px-32 py-6">
            ...
            <c:if test="${requestScope.student != null}">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-base text-gray-800">
                ...
                <div class="flex flex-col">
                  ...
                  <span>${requestScope.student.zipcode}</span>
                </div>
                <div class="flex flex-col">
                  <span class="font-semibold text-[#762124]">Διεύθυνση</span>
                  <span>${requestScope.student.street}</span>
                </div>
                <div class="flex flex-col">
                  <span class="font-semibold text-[#762124]">Αριθμός</span>
                  <span>${requestScope.student.streetNum}</span>
                </div>
              </div>
            </c:if>
          </div>
          ...
          <div class="lg:hidden text-center my-3 text-[#762124] hover:text-[#5c1a1a]">
            <a class="hover:underline" href="${pageContext.request.contextPath}/school-app/dashboard">Επιστροφή στην Αρχική σελίδα</a>
          </div>
        </div>
      </main>
    </div>
