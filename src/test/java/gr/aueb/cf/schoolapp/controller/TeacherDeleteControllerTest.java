...
class TeacherDeleteControllerTest {
    ...
    @BeforeEach
    public void setup() {
        controller = new TeacherDeleteController(mockTeacherService);
    }
    ...
    void doGetIdNullWillForwardError() throws ServletException, IOException {
        ...
        when(request.getRequestDispatcher("/WEB-INF/jsp/teacher-deleted.jsp")).thenReturn(requestDispatcher);
